...
function MainPlayersTable() {
  ...
  return (
    <div className={styles.container} style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', position: 'relative' }}>
      ...
      <div className={styles.leaderboardTitle} style={{ textAlign: 'center', color: '#1976d2', fontWeight: 700, fontSize: '2.0rem', marginBottom: '24px' }}>Main Players Leaderboard</div>
